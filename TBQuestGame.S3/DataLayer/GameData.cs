    ...
    public class GameData
    {
        ...
        public static List<GameItem> StandardGameItems()
        {
            return new List<GameItem>()
            {
                ...
                new ItemArmor (2000,0,1,GameItem.ItemUsability.MULTIPLE,"Armor of the Keeper","This otherworldly armor appears oddly organic in design despite being made of metal.","You don the strange armor.", false),
                new ItemArmor (2001,100,1,GameItem.ItemUsability.MULTIPLE, "Guardian Armor", "Standard-issue body armor among the Eronites. It was originally created for the citizen militia and is designed to protect against ranged projectiles.", "You equip the armor.", true),
                ...
                new ItemArmor(0001, 0, 1, GameItem.ItemUsability.MULTIPLE, "Tunic", "A simple tunic that protects the modesty of the wearer and little else.", "", false),                                              // These are the "default" items for the equipment slots.
